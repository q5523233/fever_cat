package com.chingteach.chartlibrary.renderer;
...
import com.chingteach.chartlibrary.formatter.BubbleChartValueFormatter;
import com.chingteach.chartlibrary.model.BubbleChartData;
...
import com.chingteach.chartlibrary.provider.BubbleChartDataProvider;
import com.chingteach.chartlibrary.util.ChartUtils;
import com.chingteach.chartlibrary.view.Chart;
...
public class BubbleChartRenderer extends AbstractChartRenderer {
    ...
    /**
     * True if bubbleScale = bubbleScaleX so the renderer should used { ChartComputator#computeRawDistanceX(float)}
     * , if false bubbleScale = bubbleScaleY and renderer should use
     * { ChartComputator#computeRawDistanceY(float)}.
     */
