...
import com.chingteach.chartlibrary.animation.ChartAnimationListener;
import com.chingteach.chartlibrary.animation.ChartDataAnimator;
import com.chingteach.chartlibrary.animation.ChartDataAnimatorV14;
import com.chingteach.chartlibrary.animation.ChartDataAnimatorV8;
import com.chingteach.chartlibrary.animation.ChartViewportAnimator;
import com.chingteach.chartlibrary.animation.ChartViewportAnimatorV14;
import com.chingteach.chartlibrary.animation.ChartViewportAnimatorV8;
import com.chingteach.chartlibrary.computator.ChartComputator;
import com.chingteach.chartlibrary.gesture.ChartTouchHandler;
import com.chingteach.chartlibrary.gesture.ContainerScrollType;
import com.chingteach.chartlibrary.gesture.ZoomType;
import com.chingteach.chartlibrary.listener.ViewportChangeListener;
import com.chingteach.chartlibrary.model.SelectedValue;
import com.chingteach.chartlibrary.model.Viewport;
import com.chingteach.chartlibrary.renderer.AxesRenderer;
import com.chingteach.chartlibrary.renderer.ChartRenderer;
import com.chingteach.chartlibrary.util.ChartUtils;
...
public abstract class AbstractChartView extends View implements Chart {
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        if (viewHeight > getResources().getDisplayMetrics().heightPixels) {
            //魅族手机出问题了
            viewHeight = Math.min(oldHeight, getResources().getDisplayMetrics().heightPixels);
        }
        chartComputator.setContentRect(getWidth(), viewHeight, getPaddingLeft(), getPaddingTop(), getPaddingRight(),
                getPaddingBottom());
