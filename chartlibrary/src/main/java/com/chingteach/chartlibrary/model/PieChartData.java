...
import com.chingteach.chartlibrary.formatter.SimplePieChartValueFormatter;
...
public class PieChartData extends AbstractChartData {
     ...
     * should also change chart fill ration using { PieChartView#setCircleFillRatio(float)}. This flag is used only
