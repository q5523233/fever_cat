...
import com.chingteach.chartlibrary.formatter.LineChartValueFormatter;
import com.chingteach.chartlibrary.formatter.SimpleLineChartValueFormatter;
...
public class Line {
    ...
    //2019 3 20 添加  末端的点突出显示，TODO
    private int lastPointRadius;

    public void setLastPointRadius(int lastPointRadius) {
        this.lastPointRadius = lastPointRadius;
    }

    public int getLastPointRadius() {
        return lastPointRadius;
    }
     ...
     * isValueSelectionEnabled set to true { Chart#setValueSelectionEnabled(boolean)}.
     */
