package com.chingteach.chartlibrary.util;
...
public abstract class ChartUtils {
    ...
    /**根据睡眠显示深浅睡的需求自定义的color**/
    public static final int COLOR_DEEP=Color.parseColor("#415CC2");
    public static final int COLOR_AHANLLOW=Color.parseColor("#039dd9");
    public static final int COLOR_BEGIN=Color.parseColor("#10B27F");
    public static final int COLOR_CLEAR=Color.parseColor("#f3d269");
    public static final int[] MYCOLORS = new int[]{COLOR_DEEP, COLOR_AHANLLOW, COLOR_BEGIN, COLOR_CLEAR};


    public static final int pickColor() {
        return MYCOLORS[(int) Math.round(Math.random() * (MYCOLORS.length - 1))];
    }
