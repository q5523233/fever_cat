...
//        Log.d("--CalendarDay:",isTemp+"");
    ...
    public String toString() {
        return "CalendarDay{" + year + "-" + month + "-" + day +"="+isTemp+"}";
    }
    ...
    public CalendarDay setHeightTemp(boolean heightTemp) {
    ...
    public CalendarDay setIsTemp(int isTemp) {
        this.isTemp = isTemp;
        return this;
    }
}
