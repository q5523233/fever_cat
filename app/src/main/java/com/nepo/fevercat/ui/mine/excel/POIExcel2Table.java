package com.nepo.fevercat.ui.mine.excel;
...
import com.nepo.fevercat.ui.mine.utils.ExcelHelper;
...
public class POIExcel2Table extends BaseExcel2Table<Cell> {
    ...
    private TableData.OnRowClickListener listener;
    ...
    public void loadDataSuc(Context context) {
        ...
        {
            smartTable.getTableData().setOnRowClickListener(listener);
        }
    ...
    public void setOnCellClickListener(TableData.OnRowClickListener listener)
    {
