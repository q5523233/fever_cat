package com.nepo.fevercat.base.rx;
...
public abstract class RxSubscriber<T> extends Subscriber<T> {
    ...
    // Gif 加载框
    private LoadDialog mGifLoadingView;
    ...
    public RxSubscriber(Context context, String msg, boolean showDialog) {
        ...
        mGifLoadingView=new LoadDialog(context);
    }
    ...
    public void onError(Throwable e) {
        ...
        //其它
            ...
            _onError(BaseApplication.getAppContext().getString(R.string.net_error_sec));
        }
    }
